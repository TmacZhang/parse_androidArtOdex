...
public class ClassDefItem {
    ...
    /**
     * struct class_def_item { uint class_idx; uint access_flags; uint
     * superclass_idx; uint interfaces_off; uint source_file_idx; uint
    ...
    public final static int ACC_PUBLIC = 0x00000001, // class, field, method, ic
            ...
            ACC_INNER_CLASS_MASK = (ACC_CLASS_MASK | ACC_PRIVATE
    ...
    public String toString() {
        return "class_idx:" + class_idx + ",access_flags:" + access_flags
                + ",superclass_idx:" + superclass_idx + ",iterfaces_off:"
                + iterfaces_off + ",source_file_idx:" + source_file_idx
                + ",annotations_off:" + annotations_off + ",class_data_off:"
                + class_data_off + ",static_value_off:" + static_value_off;
    }
